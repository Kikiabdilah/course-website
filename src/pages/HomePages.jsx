          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className='mb-4 animate__animated animate__fadeInUp animate__delay-1s'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates deserunt maiores dolorum, eos enim optio.</p>
        ...
        <Container>
          ...
          <Row>
            {kelasTerbaru.map((kelas => {
              return (
                <Col key={kelas.id} className='shadow rounded' data-aos="fade-up"
